...
const fetchAllCheckInOut = (EmployeeID) => {
  return axios.get(
    `/CWMSapi/CheckInOut/GetEmployeesByTeamLeaderIdOrTeamSubLeaderId/GetEmployeesByTeamLeaderId/${EmployeeID}`
  );
};
const addAllCheckInOut = (EmployeeID) => {
  return axios.post(
    `/CWMSapi/CheckInOut/AddCheckInOutForEmployee?employeeId=${EmployeeID}`
  );
};
const fetchAllDataWorks = (EmployeeID) => {
  return axios.post(
    `/CWMSapi/TeamWorks/GetWorkDetaiForShiftManage?id=${EmployeeID}`
  );
};
const updateDataWorks = (id, number) => {
  const requestBody = {
    teamWorkId: id,
...
const UpdateCheckInOutForEmployee = (id, checkIn, checkOut) => {
  ...
  return axios.post(
    `/CWMSapi/CheckInOut/UpdateCheckInOutForEmployee`,
    requestBody
  );
};
const AddCheckInOutForEmployee = (id, checkIn, checkOut, date) => {
  const requestBody = {
    employeeId: id,
    checkIn: checkIn,
    checkOut: checkOut,
