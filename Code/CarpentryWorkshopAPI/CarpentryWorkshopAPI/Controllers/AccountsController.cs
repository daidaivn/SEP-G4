...
namespace CarpentryWorkshopAPI.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetToken([FromBody] LoginRequest request)
        {
            ...
            var department = _context.RolesEmployees.Include(re => re.Role).Include(re => re.Department).Where(re => re.EmployeeId == user.EmployeeId && re.Role.RoleName == "Nhóm trưởng" && re.EndDate == null).Select(re => re.Department.DepartmentName).ToArray();
